...
class NativeIndex {
  public:
    ...
    Matches search_within_radius_b1x8(rust::Slice<uint8_t const> query, float radius) const;
    Matches search_within_radius_i8(rust::Slice<int8_t const> query, float radius) const;
    Matches search_within_radius_f16(rust::Slice<int16_t const> query, float radius) const;
    Matches search_within_radius_f32(rust::Slice<float const> query, float radius) const;
    Matches search_within_radius_f64(rust::Slice<double const> query, float radius) const;

    Matches exact_search_within_radius_b1x8(rust::Slice<uint8_t const> query, float radius) const;
    Matches exact_search_within_radius_i8(rust::Slice<int8_t const> query, float radius) const;
    Matches exact_search_within_radius_f16(rust::Slice<int16_t const> query, float radius) const;
    Matches exact_search_within_radius_f32(rust::Slice<float const> query, float radius) const;
    Matches exact_search_within_radius_f64(rust::Slice<double const> query, float radius) const;
